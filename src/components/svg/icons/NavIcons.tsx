...
const WrapperStyled = styled.div.attrs<IWrapper>(props=>({
  id: props.id,
  fill: props.fill,
}))`
display: inline;
...
let SvgStyled = styled.svg.attrs<ISvg>(props=>({
...
const NavIcon: React.FC<INavIcon> = ({ Type, Color, Width, onClick, }) => {
  ...
  return (
    ...
    <WrapperStyled onClick={onClick}>
      <SvgStyled viewBox={ viewBoxes[idx] }  fill={Color} width={Width}>
        <PathStyled d={paths[idx]} fill={Color} />
      </SvgStyled>
    </WrapperStyled>
    </>
  )
